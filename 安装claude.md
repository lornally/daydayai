...
##### 0726
我下载了claude的桌面端, 并且ccswitch给他做了配置, 然后, 我的vscode中的claude插件是正常的, 但是claude客户端不行, 能帮我配好吗?



##### 15:36
你帮忙看一下, 我之前让codex解决claude桌面的问题, 但是, 最后的结果是codex不能用了, 为什么?


我是用cc-switch配置的, 现在terminal下面虽然能启动codex, 但是, 还是不能使用的状态. 连接不上.
另外, 我之前一直是用的vscode的codex插件, 现在也是连接不上的状态. 为什么?